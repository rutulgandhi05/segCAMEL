...
export PREPROCESS_FOLDERS="mountain_01_Day,library_01_Day,parking_lot_01_Day,parking_lot_02_Day,sports_complex_01_Day,stream_01_Day"
...
echo "[INFO] Writing config to $RESULT_DIR"
nano $RESULT_DIR/train_config.txt <<EOL
Preprocess Folders: $PREPROCESS_FOLDERS
