...
cp --verbose $HERCULES_DATASET/06082025_e1_train_herucles_with_vel_md1_ld1_sd1/checkpoints/best_model.pth $TRAIN_CHECKPOINTS/
 
python -m scripts.preprocess
python -m scripts.inference

mkdir -p $HERCULES_DATASET/06082025_e1_train_herucles_with_vel_md1_ld1_sd1/inference_output
cp -r --verbose $INFERENCE_OUTPUT_DIR/ $HERCULES_DATASET/06082025_e1_train_herucles_with_vel_md1_ld1_sd1/inference_output