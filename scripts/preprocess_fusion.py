...
def preprocess_and_save(
    ...
    print(f"[INFO] DINO patch: {dino_patch}, DUSt3R patch: {dust3r_patch}, target crop: {target_w}x{target_h}")
    ...
    for idx, batch in enumerate(tqdm(dataloader, desc="Processing frames")):
        ...
        print(f"[Frame {idx}] DINO features: {dino_feat_tensor.shape}, Patch grid: {feature_map_size}")
